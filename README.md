...
> Repositório dedicado às tarefas da disciplina **Projeto de Software** do **4º Semestre** do curso de **Engenharia de Software** da **PUC Minas**.
...
```
Eng.-de-Software-Projeto-de-Software/
├── README.md
└── Tarefas/
    ├── Tarefa 1/
    │   └── Resenha_Big_Ball_of_Mud.pdf
    ├── Tarefa 2/
    │   └── Resenha_Microsservicos.pdf
    ├── Tarefa 3/
